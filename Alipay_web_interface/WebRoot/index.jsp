...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="autumn/Pay" method=post
			target="_blank">
		...
		<form name=tradequery action=autumn/Query method=post
			target="_blank">
		...
		<form name=traderefund action=autumn/Refund method=post
			target="_blank">
		...
		<form name=traderefundquery
			action=autumn/RefundQuery method=post
			target="_blank">
		...
		<form name=tradeclose action=autumn/Close method=post
			target="_blank">
